...
class AgentTools:
    ...
    def preprocess(self, gender, age, hypertension, heart_disease, smoking_history, bmi, HbA1c_level, blood_glucose_level):
        df = pd.DataFrame({
            "gender": [gender],
            "age": [age],
    ...
    def classify_diabetes(self, data: str):
        ...
        df = self.preprocess(gender, age, hypertension, heart_disease, smoking_history, bmi, HbA1c_level, blood_glucose_level)
